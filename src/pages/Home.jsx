...
const Home = () => {
  ...
  const auth = JSON.parse(localStorage.getItem('gramika_auth'));
    ...
    <div className="community-market min-vh-100 d-flex flex-column" ref={topRef} >
      ...
      >
        <div className="container h-100 d-flex flex-column justify-content-center">
          <motion.div className="d-flex flex-column align-items-center" variants={itemVariants} style={{ marginTop: '1em' }}>
            <motion.div className="text-center" variants={itemVariants}>
              <motion.h1 className="display-4 display-lg-3 fw-bold mb-2 mb-lg-3" style={{ fontFamily: "'Cormorant Garamond', serif" }} variants={itemVariants}>
                GRAMIKA
              </motion.h1>
              <motion.p className="lead mb-0 fs-5" variants={itemVariants}>
      ...
      <main className="flex-grow-1 py-5 bg-light-cream">
        <div className="container">
          ...
          <motion.div className="row g-4 justify-content-center" variants={containerVariants} initial="hidden" animate="visible">
            {products.map((product, index) => (
              <motion.div key={index} className="col-12 col-sm-6 col-lg-3" variants={cardVariants}>
                <div
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="how-it-works-card h-100 p-4 p-lg-5 rounded-4 shadow-sm text-center">
                ...
                <p className="mb-0">Farmers and home producers list their available products with descriptions and prices.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="how-it-works-card h-100 p-4 p-lg-5 rounded-4 shadow-sm text-center">
                ...
                <p className="mb-0">Community members browse available products and place orders directly with producers.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="how-it-works-card h-100 p-4 p-lg-5 rounded-4 shadow-sm text-center">
                ...
                <p className="mb-0">Products are either picked up at a common location or delivered directly to customers.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="row">
            {testimonials.map((testimonial, index) => (
              <motion.div key={index} className="col-md-4 mb-4" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}>
      ...
      <section ref={contactRef} id="contact" className="py-5 bg-light-green position-relative overflow-hidden">
        ...
        <div className="container position-relative">
          ...
          <div className="row g-4 justify-content-center">
            <motion.div className="col-md-4" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} viewport={{ once: true }}>
            ...
            <motion.div className="col-md-4" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }}>
              <div className="contact-card h-100 p-4 p-lg-5 rounded-4 shadow-sm text-center bg-white">
                <div className="contact-icon mb-4">
                  <FaPhone size={32} />
                </div>
            ...
            <motion.div className="col-md-4" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }} viewport={{ once: true }}>
              <div className="contact-card h-100 p-4 p-lg-5 rounded-4 shadow-sm text-center bg-white">
                <div className="contact-icon mb-4">
                  <FaEnvelope size={32} />
                </div>
