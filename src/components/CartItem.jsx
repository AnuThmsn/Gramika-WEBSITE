        ...
        <div className="cart-item">
            ...
            <div className="item-details">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '8px' }}>
                    <span style={{ fontSize: '0.85rem', color: '#666', fontWeight: 600 }}>By: {item.sellerShopName || "Unknown Seller"}</span>
                    {item.sellerFlags > 0 && (
                        <span title={`This seller has ${item.sellerFlags} reported undelivered orders`} style={{ fontSize: '0.8rem', cursor: 'help' }}>
                            🚩 {item.sellerFlags}
                        </span>
                    )}
                </div>
